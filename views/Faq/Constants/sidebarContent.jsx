export const sidebarOptions = [
    {
        ...
        dropdown: [
            ...
            { name: 'Getting in Contact with Support', id: '#general-6' },
            { name: 'Ensure Team Members Have Access to the Hub', id: '#general-7' },
        ],
    },
    {
    ...
    },
    {
        ...
        dropdown: [
            ...
            { name: 'Why Access to Data is Restricted', id: '#requesting-access-3' },
            { name: 'How to Apply for Access to Data', id: '#requesting-access-4' },
            { name: 'Access Older Versions of Data', id: '#requesting-access-5' },
            { name: 'Request Support for Issues Seeing Approved Data', id: '#requesting-access-6' },
        ],
    },
    {
