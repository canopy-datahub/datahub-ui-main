...
export const GET_STATS = `${BASE_URL}/api/entity/v1/getCenterStats`;
...
export const SEARCH_VARIABLES = `${BASE_URL}/api/search/v1/variables`;
...
export const GET_CENTERS = `${BASE_URL}/api/user/v1/user/centers`;
