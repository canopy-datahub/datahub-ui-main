...
export const GET_SUBMITTER_SUBMISSIONS = `${SUBMISSION_URL}/api/submission-service/v1/getSubmissions`;
export const DELETE_SUBMISSION = `${SUBMISSION_URL}/api/submission-service/v1/deleteSubmission?submissionId=`;
export const DOWNLOAD_STUDY_UUIDS = `/api/download/v1/download/study-uuids?sessionId=`;

// // DATA INGEST APIs
export const GET_STUDIES = `${SUBMISSION_URL}/api/submission-service/v1/getStudies`;
export const POST_DI_SUBMISSION = `${SUBMISSION_URL}/api/submission-service/v1/create-submission?studyId=`;
export const GET_CATEGORIES = `${SUBMISSION_URL}/api/submission-service/v1/getCategories`;
export const POST_DI_UPLOAD = `${SUBMISSION_URL}/api/submission-service/v1/uploadFiles/uploadFile?submissionId=`;
export const DELETE_DI_FILE = `${SUBMISSION_URL}/api/submission-service/v1/deleteFile?fileId=`;
export const GET_SUBMISSION_INFO = `${SUBMISSION_URL}/api/submission-service/v1/submissionInfo?submissionId=`;
export const GET_UPLOADED_FILES = `${SUBMISSION_URL}/api/submission-service/v1/uploadFiles/getFiles?submissionId=`;
export const POST_CREATE_BUNDLES = `${SUBMISSION_URL}/api/submission-service/v1/uploadFiles/createBundles?submissionId=`;
export const GET_BUNDLES = `${SUBMISSION_URL}/api/submission-service/v1/bundle/get?submissionId=`;
export const POST_BUNDLES = `${SUBMISSION_URL}/api/submission-service/v1/bundle/update`;
export const POST_VALIDATE_SUBMISSION = `${SUBMISSION_URL}/api/submission-service/v1/validateFiles/validate?submissionId=`;
export const GET_VALIDATION_RESULTS = `${SUBMISSION_URL}/api/submission-service/v1/validateFiles/getResults?submissionId=`;
export const PUT_REPLACE_FILE = `${SUBMISSION_URL}/api/submission-service/v1/replaceFile?fileId=`;
export const POST_SUBMIT_SUBMISSION = `${SUBMISSION_URL}/api/submission-service/v1/reviewAndSubmit/submit?submissionId=`;
export const GET_BUNDLE_FILES = `${SUBMISSION_URL}/api/submission-service/v1/bundle/getFiles?fileId=`;
export const DELETE_BUNDLE = `${SUBMISSION_URL}/api/submission-service/v1/bundle/delete?fileId=`;
export const POST_DI_ACKNOWLEDGEMENT = `${SUBMISSION_URL}/api/submission-service/v1/validateFiles/acknowledge?submit=`;
export const POST_DI_MULTI_UPLOAD = `${SUBMISSION_URL}/api/submission-service/v1/uploadFiles/multiple?submissionId=`;
...
export const POST_SAVE_VALIDATION = `${SUBMISSION_URL}/api/submission-service/v1/validateFiles/acknowledge?submit=false`;
export const POST_PREVIOUS_PAGE = `${SUBMISSION_URL}/api/submission-service/v1/bundle/previousPage?submissionId=`;
export const DELETE_MULTIPLE_DI = `${SUBMISSION_URL}/api/submission-service/v1/deleteFiles?fileIds=`;
...
export const GET_STUDY_VALUES = `${SUBMISSION_URL}/api/submission-service/v1/study/getValues?studyId=[studyId]`;
...
// CURATOR DASHBOARD
export const GET_STUDY_FILE_SUBMISSIONS = `${SUBMISSION_URL}/api/submission-service/v1/curator/getSubmissions`;
export const GET_STUDY_FILE_SUBMISSION_FILES = `${SUBMISSION_URL}/api/submission-service/v1/curator/getFilesBySubm?submissionId=`;
export const POST_STUDY_FILE_SUBMISSION_REVIEW = `${SUBMISSION_URL}/api/submission-service/v1/curator/processFiles`;
...
export const GET_UPLOAD_PORTAL_DOWNLOADS = `${SUBMISSION_URL}/api/submission-service/v1/uploadPortal/curator/dashboard`;
export const DELETE_UPLOAD_FILE = `${SUBMISSION_URL}/api/submission-service/v1/uploadPortal/curator/dashboard/delete?uploadId=`;
...
// STUDY PORTAL
export const GET_PORTAL_STUDIES = `${SUBMISSION_URL}/api/submission-service/v1/uploadPortal/getStudies`;
export const UPLOAD_PORTAL_ZIP = `${SUBMISSION_URL}/api/submission-service/v1/uploadPortal/upload`;
